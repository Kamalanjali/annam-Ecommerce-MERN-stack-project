...
export const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="bg-gradient-to-br from-green-50 via-white to-amber-50 py-20">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@annam.com</p>
                  </div>
                </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  required
                  className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:border-green-400 transition-colors duration-200 resize-none"
                ></textarea>
              </div>
